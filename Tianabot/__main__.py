...
import Shaanbot.modules.sql.users_sql as sql

from Shaanbot import (
    ALLOW_EXCL,
    CERT_PATH,
    DONATION_LINK,
    LOGGER,
...
from Shaanbot.modules import ALL_MODULES
from Shaanbot.modules.helper_funcs.chat_status import is_user_admin
from Shaanbot.modules.helper_funcs.misc import paginate_modules
...
───────────────────""".format(
                ...
                reply_markup=InlineKeyboardMarkup(
                 [
                  [InlineKeyboardButton(text="📄 Source", url="https://t.me/mr_agora"), 
...
• We also thank all the groups who rely on our Bot for this service, we hope you will always like it: we are constantly working to improve it!""",
        ...
        query.message.edit_text(
            text="""*Shaanbot is Now Open Source Bot Project.*
...
*Click below Button to Get Source Code.*""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="📄 𝙎𝙤𝙪𝙧𝙘𝙚", url="github.com/Prince-Botz/Shaanbot"),                 
                    InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="about_"),
                 ]    
                ]
            ),
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "𝘼𝙂𝙊𝙍𝘼 𝙎𝙀𝙍𝙑𝙀𝙍 𝙄𝙎 𝙐𝙋𝘿𝘼𝙏𝙀𝘿 ✅")
        except Unauthorized:
            LOGGER.warning(
